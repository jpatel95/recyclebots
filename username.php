...
<body>
  <nav role="navigation">
	...
	<h4 class="center">Member Confirmed!</h4>
	<h5 class="center">Cool! You're on your way to a more eco-friendly you!</h5>
	<h6 class="center">Your member code is : <?php 
	$firstName = $_POST['first'];
	$lastName = $_POST['last'];
	$userName = substr($firstName,0,1).$lastName.strlen($firstName);
...
if (mysqli_connect_errno())
  ...
  $sql="INSERT INTO Users (UserName, FirstName, LastName) VALUES ('$userName','$_POST[first]','$_POST[last]')";
